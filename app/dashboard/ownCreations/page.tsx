...
const OwnCreations = () => {
        ...
        if (creation.image_url) {
          try {
            ...
            if (typeof creation.image_url === 'string') {
             ...
             const imageUrls = creation.image_url.filter((url: string) => typeof url === 'string' && url.length > 0);
  ...
  const getSourceBadgeColor = (source: string) => {
    return source === 'image_url' ? 'bg-blue-100 text-blue-800' : 'bg-green-100 text-green-800';
  };
